...
export function FloatingConsole() {
  ...
  return (
    <>
      {isConsoleOpen && (
        <div className="fixed bottom-20 right-4 w-[800px] h-[500px] bg-zinc-950/95 backdrop-blur-md border border-zinc-800/50 rounded-xl shadow-2xl z-50 flex flex-col animate-in slide-in-from-bottom-4 duration-200 ring-1 ring-white/10">
      ...
      <Button
        ...
        className={`fixed bottom-4 right-4 h-12 px-4 rounded-xl shadow-lg shadow-primary/5 z-50 gap-2.5 transition-all duration-300 font-medium tracking-wide ${
          isConsoleOpen
            ...
            : "bg-zinc-900/90 backdrop-blur border border-zinc-800 text-zinc-400 hover:text-white hover:border-zinc-700 hover:bg-zinc-800"
        }`}
      >
