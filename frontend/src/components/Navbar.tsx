...
export function Navbar() {
  const { accounts, activeAccount, switchAccount } = useLauncherContext();
  const navigate = useNavigate();

  return (
    <nav className="h-14 border-b border-zinc-800 bg-zinc-950/50 backdrop-blur-md flex items-center justify-between px-4 select-none drag-region">
